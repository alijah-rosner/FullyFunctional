...
namespace FFunctional
{
  ...
  void Scene::SetDrawing(bool set)
  {
    Drawing_ = set;
  }
  ...
  void Scene::SetRunning(bool set)
  {
    Running_ = set;
  }
  ...
  void Scene::Update(float dt)
  {
    ...
    if (Running_)
    {
      ...
      sceneEcs_.Update<SoundBehavior>(dt);
      ...
      sceneEcs_.Update<BrokenDoorBehavior>(dt);
			sceneEcs_.Update<DestroyTimerBehavior>(dt);
      sceneEcs_.Update<FadeControllerBehavior>(dt);
