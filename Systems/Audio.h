...
namespace FFunctional /* The Perfectly Normal Full Functional Game Engine * * */
{
  ...
  ***************************************************************************/
    ...
    public:
        ...
        std::shared_ptr<Sound> GetSound(std::string string) const;
        ...
        void CreateAllSounds(rapidjson::Value& value);

        std::unordered_map<std::string, std::shared_ptr<Sound>>* GetLibrary();

        ~Audio();


    private:
        std::unordered_map<std::string, std::shared_ptr<Sound>> library_;
        Engine* mainEngine_;
